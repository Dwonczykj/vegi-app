...
import 'package:package_info/package_info.dart' as _i18;
import 'package:phone_number/phone_number.dart' as _i22;
import 'package:redux/redux.dart' as _i24;
...
import 'package:vegan_liverpool/common/router/routes.dart' as _i23;
import 'package:vegan_liverpool/initStore.dart' as _i31;
import 'package:vegan_liverpool/models/app_state.dart' as _i25;
import 'package:vegan_liverpool/new_version.dart' as _i17;
import 'package:vegan_liverpool/services/apis/fxService.dart' as _i5;
import 'package:vegan_liverpool/services/apis/locationService.dart' as _i14;
import 'package:vegan_liverpool/services/apis/peeplEats.dart' as _i19;
import 'package:vegan_liverpool/services/apis/peeplPay.dart' as _i20;
...
import 'package:vegan_liverpool/services/apis/stripePay2.dart' as _i26;
import 'package:vegan_liverpool/services/apis/vegiESCService.dart' as _i29;
import 'package:vegan_liverpool/utils/connectionChecker.dart' as _i16;
...
import 'package:vegan_liverpool/utils/onboard/Istrategy.dart' as _i12;
import 'package:vegan_liverpool/utils/stripe.dart' as _i28;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i14.LocationService>(
        () => _i14.LocationService(gh<_i4.Dio>()));
    gh.lazySingleton<_i15.Logger>(() => loggerDi.logger);
    gh.lazySingleton<_i16.NetworkInfo>(
        () => _i16.NetworkInfo(gh<_i13.InternetConnectionChecker>()));
    gh.lazySingleton<_i17.NewVersion>(() => servicesModule.newVersion);
    await gh.factoryAsync<_i18.PackageInfo>(
      () => packageInfoDi.packageInfo,
      preResolve: true,
    );
    gh.lazySingleton<_i19.PeeplEatsService>(
        () => _i19.PeeplEatsService(gh<_i4.Dio>()));
    gh.lazySingleton<_i20.PeeplPayService>(
        () => _i20.PeeplPayService(gh<_i4.Dio>()));
    gh.lazySingleton<_i21.PeeplPayService>(() => _i21.PeeplPayService());
    gh.lazySingleton<_i22.PhoneNumberUtil>(() => phone.phoneNumberUtil);
    gh.lazySingleton<_i23.RootRouter>(() => servicesModule.rootRouter);
    gh.singletonAsync<_i24.Store<_i25.AppState>>(() => registerModule.store());
    gh.lazySingleton<_i26.StripePayService>(() => _i26.StripePayService());
    gh.lazySingleton<_i27.StripePayService>(
        () => _i27.StripePayService(gh<_i4.Dio>()));
    gh.lazySingleton<_i28.StripeService>(() => _i28.StripeService());
    gh.lazySingleton<_i29.VegiESCService>(
        () => _i29.VegiESCService(gh<_i4.Dio>()));
    gh.lazySingleton<_i30.LogIt>(() => _i30.LogIt(gh<_i15.Logger>()));
    return this;
  }
}
