...
class _ESCExplanationsDrillDownListViewState
  ...
  final Map<String,Map<String,String>> dummyExplanations = {
    'Independence': {
      'Estimate': 'SME with < 10 employees and supply chain contained in NW of England',
    },
    'CO2e': {
      'Estimate': 'Based on similar product X taken from Y.com, we estimate a cost of 0.01 tonnes CO2e per product manufactured'
    },
    'Water usage': {
      'No information': 'No information has been inferred or found for this product or brand as a whole regarding the water used to produce the product',
    },
    'Brand ethics': {
      'Charity': 'Monthly donations to UK school meals as reported by XXX on twitter in dd/m/yyyy',
    },
    'Land usage': {
      'Claim': 'A reported 3000 Ha of land used annually to meet annual production volumes historically at circa 1 million. Sourced from `company blog`.',
    },
  }
          ...
          children: [
            ...
            ListView.separated(
              ...
              itemBuilder: (_, index) => ListTile(
                ...
                subtitle: RichText(
                  text:  dummyExplanations.entries.elementAt(index).value.entries.first.key,
                ),
                trailing: Text(
