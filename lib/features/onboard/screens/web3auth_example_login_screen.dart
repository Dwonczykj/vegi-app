...
@RoutePage()
class Web3AuthExampleLoginScreen extends StatefulWidget {
  @override
  _Web3AuthExampleLoginScreenState createState() =>
      _Web3AuthExampleLoginScreenState();
}

class _Web3AuthExampleLoginScreenState
    extends State<Web3AuthExampleLoginScreen> {
  String _result = '';
  bool logoutVisible = false;
  String rpcUrl = 'https://rpc.ankr.com/eth_goerli';

  /// web3auth's plug and play client id
  /// i.e. 'BEglQSgt4cUWcj6SKRdu5QkOXTsePmMcusG5EAoyjyOYKlVRjIF1iCNnMOTfpzCiunHRrMui8TIwQPXdkQ8Yxuk'
  final publicId = Secrets.WEB3AUTH_CLIENT_ID;
  ...
  Future<void> initPlatformState() async {
    ...
    /// ~ Whitelisting for Mobile Docs -> https://web3auth.io/docs/dashboard-setup/whitelisting#whitelisting-for-mobile-apps
    /// https://web3auth.io/docs/content-hub/blog/comprehensive-guide-to-deep-links-and-app-links-in-android
