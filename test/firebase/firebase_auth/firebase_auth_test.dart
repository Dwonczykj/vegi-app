  ...
  group('$FirebaseAuth', () {
    ...
    group('signInWithCredential()', () {
      ...
      test('EmailAuthProvider (withLink) signInWithCredential', () async {
        ...
        await auth.signInWithCredential(credential);
        final EmailAuthCredential captured = verify((await mockAuthPlatform
                .signInWithCredential(captureAny)) as EmailAuthCredential)
            .captured
      ...
      test('PhoneAuthProvider signInWithCredential', () async {
        ...
        await auth.signInWithCredential(credential);
        final PhoneAuthCredential captured = verify((await mockAuthPlatform
                .signInWithCredential(captureAny)) as PhoneAuthCredential)
            .captured
